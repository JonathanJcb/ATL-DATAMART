...
INSERT INTO payment_type (payment_typeid, name_payment_type) VALUES (0,'Type NULL'), (1,'Carte de credit'), (2, 'especes'), (3, 'aucun'), (4, 'Dispute'), (5, 'Unknown'), (6, 'Voided trip');
...
ALTER TABLE nyc_row ADD CONSTRAINT fk_vendor FOREIGN KEY (vendorid) REFERENCES vendor(vendorid);
ALTER TABLE nyc_row ADD CONSTRAINT fk_ratecode FOREIGN KEY (ratecodeid) REFERENCES ratecode(ratecodeID);
ALTER TABLE nyc_row ADD CONSTRAINT fk_payment_type FOREIGN KEY (payment_type) REFERENCES payment_type(payment_typeid);
ALTER TABLE nyc_row ADD CONSTRAINT fk_pulocation FOREIGN KEY (pulocationid) REFERENCES location(locationID);
ALTER TABLE nyc_row ADD CONSTRAINT fk_dolocation FOREIGN KEY (dolocationid) REFERENCES location(locationID);